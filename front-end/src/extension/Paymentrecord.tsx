...
export default function Paymentrecord() {
    const paymentrecords = useSelector((state: any) => state.dialog.data)
    const mode = paymentrecords.mode;
    const data = paymentrecords.data;


    const [inpTitle, setInpTitle] = useState(data.title || "")
    const [inpMoneyUsed, setInpMoneyUsed] = useState(data.MoneyUsed || "")
    ...
    const check_paymentrecords = useSelector((state: any) => state.dataHome.paymentrecords);
    ...
    const Nextstep = async () => {
        ...
        if ((selectedFile !== null || imageUrl !== "") && inpTitle !== "" && inpMoneyUsed !== "" && inpLocation !== "" && inpDescription !== "" && inpAddress !== "") {
                ...
                if (selectedFile !== null) {
                    ...
                    uploadTask.on(
                        ...
                        async () => {
                            ...
                            setUrl(downloadURL);
                            const response = await createPaymentrecords({
                                imgTitle: downloadURL,
                                title: inpTitle,
                                MoneyUsed: inpMoneyUsed,
                                type: inpType,
    ...
    return (
        ...
        >
            ...
            <Box>
                ...
                >Title</p>
                <input type="text" placeholder="By food for kid"
                    style={{
                        width: '100%',
                        background: '#FFFFFF',
            ...
            <Box>
                ...
                >
                    <input type="number" placeholder="1000"
                        ...
                        value={inpMoneyUsed}
                        onChange={(e) => {
                            setInpMoneyUsed(e.target.value)
                        }}
                    />
                    <FormControl sx={{
                        m: 1, width: '15%',
