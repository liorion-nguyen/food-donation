...
import { createPaymentrecords } from '../../API/Api';
...
export default function Paymentrecord() {
    ...
    const Nextstep = async () => {
        setLoading(true)
        if (selectedFile !== null && inputData.Description !== "" && inputData.Address !== "" && inputData.Location !== "" && inputData.MoneyUsed !== "" && inputData.Title !== "") {
            createPaymentrecords({
                event: inputData.Title,
                imgEvent: "Img",
                moneyUsed: inputData.MoneyUsed,
                usedDate: getDate(),
                status: "Paid",
            })
