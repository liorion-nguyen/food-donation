                                        ...
                                        onClick={() => {
                                            if (ListOverView.button === "New post") {
                                                dispatch(DialogHomeActions.showDialog({
                                                    ...
                                                    inputrow2: 'title',
                                                    inputrow2placeholder: 'Crawford Room, Mortlock Wing....',
                                                    contentButton: 'Create new post',
                                                }))
                                            }
                                                ...
                                                dispatch(DialogHomeActions.showDialog({
                                                    ...
                                                    contentButton: 'Create new location'
                                                }))
                                            }
                                                ...
                                                dispatch(DialogHomeActions.showDialog({
                                                    ...
                                                    subtitle: 'Voucher Information',
                                                    contentButton: 'Create new voucher'
                                                }))
                                            }
                                                ...
                                                dispatch(DialogHomeActions.showDialog({
                                                    ...
                                                    subtitle: 'Payment record information',
                                                    contentButton: 'Create new post'
                                                }))
                                            }
                                        }}
